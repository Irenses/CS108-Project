...
<body>
   ...
   <div id="wrapper">
      ...
      %>
        <br>
        <p><span>Your picture url:</span></p>
        	<form action="AddPRQuestion" method="post">
	  			<ul>
				  	<li>	
				  	  <input id="question" class="fieldBox" placeholder="Your picture url" type="text" name="question"/>	
				  	</li>
				</ul>
        <br>
