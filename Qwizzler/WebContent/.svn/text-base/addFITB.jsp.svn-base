...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
	...
	request.setAttribute("type", "fitb");
   ...
   <div id="wrapper">
      ...
      %>
        ...
        <p><span>Your question:</span></p>
        	<form action="AddFITBQuestion" method="post">
	  			<ul>
				  	<li><input id="question" class="fieldBox" placeholder="The part before blank" type="text" name="question1"/><input id="question" class="fieldBox" placeholder="The part after blank" type="text" name="question2"/></li>
				</ul>
        <br>
      ...
      <input type="hidden" name="type" value="fitb">
